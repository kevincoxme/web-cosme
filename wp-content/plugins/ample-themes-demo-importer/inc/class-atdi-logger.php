...
// Include files.
require ATDI_PATH . 'inc/importer/class-logger.php';
require ATDI_PATH . 'inc/importer/class-logger-cli.php';

class ATDI_Logger extends ATDI_HM_WP_Importer_Logger_CLI {
	...
	/**
	 * Overwritten log function from ATDI_HM_WP_Importer_Logger_CLI.
	 *
