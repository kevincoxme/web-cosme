            ...
            <div class="inner-header-banner overlay bg-img"
                ...
                <div class="container">
                    <header class="section-header">
                        <h3 class="entry-title"><?php printf(esc_html__('Search Results for: %s', 'online-portfolio'), '<span>' . get_search_query() . '</span>'); ?></h3>
                    ...
                    <div class="row"><?php } ?>
                        ...
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main" role="main">
                                ...
                                <h2 class="entry-title"><?php printf(esc_html__('Search Results for: %s', 'online-portfolio'), '<span>' . get_search_query() . '</span>'); ?></h2>
                                <?php
                                if (have_posts()) :
